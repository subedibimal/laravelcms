<template>
  <div class="relative">
    ...
    >
      <img :src="`/flag_${locale}.png`" alt="flag" class="w-8 h-8">
      ...
      <ul v-if="isVisible" ref="dropdown" class="absolute normal-case z-30 font-normal xs:left-0 lg:right-0 bg-white shadow overflow-hidden rounded w-48 border mt-2 py-1 lg:z-20">
        ...
        <li>
          <a
            ...
            @keydown.esc.exact="hideDropdown"
          >
            <img src="/flag_np.png" alt="english flag" class="h-8 w-8">
            <span class="ml-2">नेपाली</span>
          </a>
        </li>
      </ul>
    </transition>
